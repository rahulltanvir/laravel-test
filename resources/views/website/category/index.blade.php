            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <ul class="breadcrumb-nav">
                        ...
                        @isset($subcategory)
                            <li>
                                <a href="{{ route('product-category', $subcategory->category->id) }}">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="website/assets/images/products/product-1.jpg"
                                                            alt="#">
                                                        <div class="button">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="website/assets/images/products/product-2.jpg"
                                                            alt="#">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="website/assets/images/products/product-3.jpg"
                                                            alt="#">
                                                        <div class="button">
                                                            <a href="product-details.html" class="btn"><i
                                                                    class="lni lni-cart"></i> Add to
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="website/assets/images/products/product-4.jpg"
                                                            alt="#">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="website/assets/images/products/product-7.jpg"
                                                            alt="#">
