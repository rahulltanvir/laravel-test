                    ...
                    @foreach ($orders as $order)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.order.details', $order->id) }}" class="btn btn-primary btn-sm mb-1">
                                ...
                                @if ($order->payment_method != 'cod' && $order->payment_status == 'Pending')
                                    <form action="{{ route('admin.payment.approve', $order->id) }}" method="POST"
                                        ...
                                        <button type="submit" class="btn btn-success btn-sm mb-1"
                                            onclick="return confirm('Are you sure you verified this payment?')">
                                ...
                                @if ($order->status == 'confirmed')
                                    <a href="{{ route('admin.invoice', $order->id) }}" class="btn btn-dark btn-sm mb-1">
