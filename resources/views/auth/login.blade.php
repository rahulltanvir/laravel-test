...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/eliteadmin/pages-login-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 17:00:28 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title>My eCommarce Dashboard - @yield('title')</title>
...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(admin/assets/images/background/login-register.jpg);">
        <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material text-center"  action="{{ route('login') }}" method="post">
                    @csrf
                    <a href="javascript:void(0)" class="db"><img src="admin/assets/images/logo-icon.png" alt="Home" /><br/><img src="admin/assets/images/logo-text.png" alt="Home" /></a>
